...
使用 `/disco-elysium:de-toggle on` 开启极乐迪斯科模式。

开启后，24种技能会自动装备，在对话中根据语境自动触发——就像在游戏中一样。技能以"脑内声音"的形式突兀出现，时而迎合你，时而和你作对，带来沉浸式的游戏体验。

```
用户：我纠结要不要辞职

[通情达理] [成功] - 你能感觉到那份厌倦，像一层灰蒙在你心口...

[平心定气] [成功] - 深呼吸。你见过更糟的。这只是人生的一个路口。

[Claude Code] - 这是人生的重要决定，你可以考虑几个方面...
```
